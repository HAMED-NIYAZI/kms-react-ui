      ...
      <aside className="app-sidebar sidebar-scroll">
        ...
        <div className="main-sidemenu">
          ...
          <ul className="side-menu">
            ...
            <li className="slide">
              <NavLink className="side-menu__item" to={"/test"}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="side-menu__icon"
                  viewBox="0 0 24 24"
                ...
                <span className="side-menu__label">Test</span>
                <span className="badge bg-success text-light" id="bg-side-text">
                  1
                </span>
              </NavLink>
            </li>
            <li className="side-item side-item-category">عمومی</li>
            <li className="slide">
              <a className="side-menu__item" href="icons.html">
                ...
                <span className="side-menu__label">آیکون ها</span>
                <span className="badge bg-danger text-light" id="bg-side-text">
                  جدید
                </span>
              </a>
            </li>
